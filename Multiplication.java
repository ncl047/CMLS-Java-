...
public class Multiplication extends Mathematics{
	...
	public Multiplication(){ //constructor
		...
		frame = new JFrame("Let's Learn Multiplication!");
		panel_home = new JPanel();
		q1_bg = new JLabel();
		
		//set size and properties of frame
		frame.pack();
	...
	public void homepage(){
		...
		home_bg = new JLabel(formatImage("multiplication/multiplication_video_bg.png", 1280, 720));
		...
		try {
			ImageIcon imgIcon = new ImageIcon(this.getClass().getResource("multiplication/multiplication_video.gif"));
			video = new JLabel(imgIcon);
			video.setBounds(190, 40, 880, 495);
			panel_home.add(video);
			video_sound = s.playMusic("multiplication/multiplication_video_music.wav");
			video_sound.start(); 
	...
	public void lesson1(){
		...
		init_lesson1(panel_lesson1, "multiplication/multiplication_q1.png");
	...
	public void lesson2(){
		...
		init_lesson2(panel_lesson2, "multiplication/multiplication_q2.png");
	...
	public void lesson3(){
		...
		//initializes the components and resources for lesson 2
		init_lesson3(panel_lesson3, "multiplication/multiplication_q3.png");
	...
	ActionListener act = new ActionListener(){
		public void actionPerformed(ActionEvent e) {
			...
			//handling wrong selections until line 176
			...
			else if(e.getSource() == btn_q2_ans1 || e.getSource() == btn_q2_ans2 ){
				wrong_audio = s.playMusic("Audio/Wrong audio.wav");
				wrong_audio.start();
			...
			//If the wrong answer button for question 3 is clicked
			...
			else if(e.getSource() == btn_q2_ans3){
				correct_audio = s.playMusic("Audio/Correct audio.wav");
				correct_audio.start();
				frame.remove(panel_lesson2);
				lesson3();
				...
				// Write "multiplication" to "completed_missions.txt" file, indicating addition mission is done
